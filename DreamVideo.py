"""
**FROM GITHUB USER 'graphific' -- https://github.com/graphific/DeepDreamVideo/
This file Deep Dreams video by processing each frame in the directory one after another
"""
...
def main(input, output, image_type, gpu, model_path, model_name, preview, octaves, octave_scale, iterations, jitter, zoom, stepsize, blend, layers, guide_image, start_frame, end_frame, verbose):
    ...
    if blend is None: blend = random #can be nr (constant), random, or loop  #Original default 0.5
    ...
    param_fn = model_path + model_name # 'googlelet_places205_train_iter_2400000.caffemodel'
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '-t', '--model_path',
        dest='model_path',
        default='./googlenet_places205/',
        help='Model directory to use')
    parser.add_argument(
        '-m', '--model_name',
        dest='model_name',
        default='googlelet_places205_train_iter_2400000.caffemodel',
